module accelerator(
    ...
    always@(posedge clk or negedge rst_n) begin
        if(!rst_n) begin
            ...
            if(state==4'b0001 | state == 4'b0011 | state == 4'b0100 | state == 4'b1001) begin
    ...
    wire [7:0] in_x;
    wire [79:0] in_w;
    assign in_x = (state == 4'b0001) ? {(parallel == 1'b1) ? {input_data[11:8], input_data[3:0]} : {input_data[7:0]}} : {((state == 4'b0100) ? {mid_result[counter]} : {8'b0})};
